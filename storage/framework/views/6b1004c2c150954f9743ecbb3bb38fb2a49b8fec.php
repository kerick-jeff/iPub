    ...
    <div class="box box-primary spacious-bottom">
      <div class="box-body box-profile">
        ...
        <ul class="list-group list-group-unbordered">
          ...
          <li class="list-group-item">
            <b>Invited</b> <a class="pull-right"><?php echo e($noInviteds); ?></a>
          </li>
        </ul>
            ...
            <div class="col-md-6">
              <div class="box box-info" id = "inviteds">
                <div class="box-header with-border">
                  ...
                  <div class="box-tools pull-right">
                    <span class="label label-info"><?php echo e($noInviteds); ?></span>
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                    <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                  </div>
                </div>
                ...
                <?php if($noInviteds > 0): ?>
                  <div class="box-body">
                    <ul class="products-list product-list-in-box">
                      <?php foreach($inviteds as $invited): ?>
                        <li class="item">
                          <div class="product-img">
                            <img src="<?php echo e(asset('ipub/dist/img/boxed-bg.jpg')); ?>" alt="Invited background">
                          </div>
                          <div class="product-info">
                            <a class="product-title"><?php echo e($invited->email); ?></a>
                            <span class="product-description">
                              Invitation status : <?php echo e($invited->accepted ? "Accepted" : "Not accepted"); ?>
                  ...
                  <!-- /.box-body -->
                  <?php if($noInviteds > count($inviteds)): ?>
                    <div class="box-footer text-center">
        ...
        $.ajax({
            ...
            success : function(inviteds) {
                ...
                for(var i = 0; i < inviteds.length; i++) {
                    result += "<li class='item'>";
                    result += "<div class='product-img'>";
                    result += "<img src='<?php echo e(asset('ipub/dist/img/boxed-bg.jpg')); ?>' alt='Invited background'>";
                    result += "</div>";
                    result += "<div class='product-info' style = 'text-align: left'>";
