                        ...
                        <table width="70" align="left" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="70" style="padding: 0 20px 20px 0; font-size:45px; font-weight: 300;">
                              <a href="<?php echo e(url('/')); ?>" style = "padding: 0 5px 0 5px; text-decoration: none; color: #ffffff; background-color: #367fa9; border-bottom: 0 solid transparent;"><b style = "font-weight: 700">iP</b>ub</a>
                            </td>
                            <td>
                              <!--[if (gte mso 9)|(IE)]>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="center" class="footercopy">
                              <strong>Copyright &copy; <?php echo e(date('Y')); ?> <a href="<?php echo e(url('/')); ?>">iPub.com</a></strong> . All rights reserved.
                            </td>
                          </tr>
                        </table>
                      </td>
